...
Now you can visualise your graph by using the following query.
...
If your model needs improving, follow the example in <<anchor-1,Step 3>> and modify the code in a text editor. Visualise again. Repeat. Until you like it.
